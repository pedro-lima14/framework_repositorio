...
class _TelaDetalhesPokemonState extends State<TelaDetalhesPokemon> {
  ...
  void initState() {
    ...
    Future.microtask(() {
      context.read<PokemonProvider>().carregarDetalhes(
        widget.idPokemon,
      );
    });
  }
    ...
    return Scaffold(
      ...
      body: provider.carregando
          ...
          : pokemon == null
              ? Center(
                  child: Text(
                    provider.erro ?? 'Pokémon não encontrado',
                  ),
                )
